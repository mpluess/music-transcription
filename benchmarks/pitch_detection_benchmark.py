...
# pitch_detector = CnnPitchDetector.from_zip('../models/pitch_detection/20170621_1448_audio_effects_mono_80-perc.zip')
# pitch_detector.config['onset_group_threshold_seconds'] = 0.05
